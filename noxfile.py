...
@session(python=["3.11", "3.12", "3.13", "3.14"], uv_groups=["test"])
def test(s: Session):
...
@session(python=["3.11", "3.12", "3.13", "3.14"], uv_groups=["test"], uv_extras=["numpy"])
...
@session(python=["3.11", "3.12", "3.13", "3.14"], uv_groups=["test"], uv_extras=["cffi"])
