...
def index_variables_add(self: Add):
    ...
    return left_variables + [variable for variable in right_variables if variable not in left_variables]
...
def index_variables_assignment(self: Assignment):
    ...
    return target_variables + [variable for variable in expression_variables if variable not in target_variables]
